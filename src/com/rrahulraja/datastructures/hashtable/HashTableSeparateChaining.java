...
public class HashTableSeparateChaining<K, V> implements Iterable<K> {
	...
	// Finds and returns a particular entry in a given bucket if it exits, returns
	// null otherwise
	...
	// Returns the list of keys found in the hash-table
	public List<K> keys() {
	...
	// Returns the list of values found in the hash-table
				...
				if(bucketIter == null || !bucketIter.hasNext()) {
					...
					while(++bucketIndex < capacity) {
						if(table[bucketIndex] != null) {
							...
							// Make sure iterator actually has elements -_-
