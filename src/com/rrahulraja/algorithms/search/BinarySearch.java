package com.rrahulraja.algorithms.search;
...
public class BinarySearch {
	...
	// Using a small epsilon value is preferred approach
	...
	public static void main(String[] args) {
		...
		double lo = 0.0, hi = 875.0, target = 875.0;
		...
		// Example #2
		// Suppose we want to find t he radius of a sphere with volume 100m^3 using
		...
		//
		// Note: this is a silly example because you could not just solve for r, but it
